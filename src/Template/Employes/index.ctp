    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link('Envoi formation', ['controller' => 'Employes', 'action' => 'cake_pdf_download', 'id' => $employe->id]) ?><br>
                    <?= $this->Html->link(__("View"), ['action' => 'view', $employe->id]) ?><br>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $employe->id]) ?><br>
